...
var tests = new (string Name, Action Test)[]
{
    ...
    .Concat(PurchasingImp001Tests.Cases)
    .Concat(PurchasingImp001ApplicationTests.Cases)
    .Concat(WarehouseImp001Tests.Cases)
    .Concat(WarehouseImp001ApplicationTests.Cases)
    .ToArray();
