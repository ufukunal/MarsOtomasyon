...
{
    public function test_barcode_label_extension_is_disabled_by_default(): void
    {
        self::assertFalse(app(FeatureRegistry::class)->enabled(FeatureKey::BarcodeThermalLabels));
    }
