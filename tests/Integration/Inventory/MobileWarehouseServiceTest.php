...
it('keeps the mobile warehouse extension disabled by default and exposes all milestone operation permissions', function (): void {
    $registry = app(FeatureRegistry::class);
    $service = app(MobileWarehouseService::class);

    expect($registry->enabled(FeatureKey::MobileWarehouse))->toBeFalse()
