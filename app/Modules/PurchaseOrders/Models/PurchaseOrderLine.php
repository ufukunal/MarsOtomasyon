...
{
    protected $fillable = [
        'company_id', 'purchase_order_id', 'logical_line_key', 'position', 'product_id',
        'warehouse_id', 'location_id', 'product_code', 'product_name', 'description',
        'quantity', 'price_basis', 'unit_price', 'line_discount_rate', 'tax_id',
        'tax_code', 'tax_rate', 'tax_is_zeroed', 'tax_zero_reason_id',
        'tax_zero_reason_code', 'base_net', 'line_discount_net', 'document_discount_net',
    ...
    /** @return HasOne<PurchaseOrderLineProgress, $this> */
    public function progress(): HasOne
    {
        return $this->hasOne(PurchaseOrderLineProgress::class, 'purchase_order_line_id');
    }

    /** @return HasMany<PurchaseOrderLineProgressEffect, $this> */
    public function progressEffects(): HasMany
    {
        return $this->hasMany(PurchaseOrderLineProgressEffect::class, 'purchase_order_line_id');
    }
}
