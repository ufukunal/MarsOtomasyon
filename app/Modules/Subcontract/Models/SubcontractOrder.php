...
final class SubcontractOrder extends Model
{
    ...
    {
        return $this->hasMany(SubcontractOrderMaterial::class, 'subcontract_order_id');
    }

    /** @return HasMany<SubcontractReceipt, $this> */
    public function receipts(): HasMany
    {
        return $this->hasMany(SubcontractReceipt::class, 'subcontract_order_id');
    }

    /** @return HasMany<SubcontractLoss, $this> */
    public function losses(): HasMany
    {
        return $this->hasMany(SubcontractLoss::class, 'subcontract_order_id');
    }

    /** @return HasMany<SubcontractEvent, $this> */
    public function events(): HasMany
    {
        return $this->hasMany(SubcontractEvent::class, 'subcontract_order_id');
    }
}
