...
final class SalesOrderLine extends Model
{
    protected $fillable = [
        ...
        'tax_zero_reason_id', 'tax_zero_reason_code', 'base_net', 'line_discount_net',
        'document_discount_net', 'net_total', 'tax_total', 'gross_total',
    ];

    protected function casts(): array
    {
        return [
            'position' => 'integer', 'price_basis' => PriceBasis::class, 'quantity' => 'decimal:6',
            'unit_price' => 'decimal:6', 'line_discount_rate' => 'decimal:6', 'tax_rate' => 'decimal:6',
            'base_net' => 'decimal:6', 'line_discount_net' => 'decimal:6', 'document_discount_net' => 'decimal:6',
            'net_total' => 'decimal:6', 'tax_total' => 'decimal:6', 'gross_total' => 'decimal:6',
    ...
    public function sourceRevisionLine(): BelongsTo { return $this->belongsTo(QuoteRevisionLine::class, 'source_quote_revision_line_id'); }
    ...
    public function taxZeroReason(): BelongsTo { return $this->belongsTo(TaxZeroReason::class); }
}
