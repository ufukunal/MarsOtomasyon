const form = document.querySelector('#sales-order-form[data-product-search-url]');
        ...
        entries.forEach((entry) => {
            ...
            const selectProduct = (product) => {
                ...
                if (unitPrice instanceof HTMLInputElement) {
                    unitPrice.value = String(product.sale_price_net);
                    unitPrice.dispatchEvent(new Event('input', { bubbles: true }));
                }
                if (help instanceof HTMLElement) {
                    help.textContent = `KDV %${product.tax_rate} · Net satış fiyatı ${product.sale_price_net}`;
                }
            ...
            const renderResults = () => {
                ...
                if (options.length === 0) {
                    ...
                    options.forEach((product) => {
                        ...
                        meta.textContent = `KDV %${product.tax_rate} · ${product.sale_price_net}`;
